...
A pixel-faithful partial clone of [enterprise.accredian.com](https://enterprise.accredian.com) built with **Next.js 16 (App Router)**, **TypeScript**, and **Tailwind CSS V4**.
